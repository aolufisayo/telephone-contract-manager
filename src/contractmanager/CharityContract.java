 ...
 * @author TOSHIBA
 */
public class CharityContract extends Contract implements Subject {

    public CharityContract() {

    }

    public CharityContract(String customerName, char accountType, double discountedPrice,
